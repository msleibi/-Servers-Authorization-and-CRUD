...
# Create dummy user
User1 = User(name="Mohammad Sleibi", email="msalibi83@gmail.com",
             picture='https://drive.google.com/open?id=1g9F8ipLamXKnpYp5N2MS8LNydkm3_v0h')
session.add(User1)
session.commit()
...
print "added menu items with users!"